defmodule EctoWorkshopWeb.RecipeControllerTest do
  use EctoWorkshopWeb.ConnCase

  alias EctoWorkshop.Menu

  @create_attrs %{calories: 42, cook_time: 42, description: "some description", prep_time: 42, title: "some title"}
  ...
  def fixture(:recipe) do
    {:ok, recipe} = Menu.create_recipe(@create_attrs)
    recipe
  end
